	...
	<BODY>
		...
		<div class="register_css">
			...
			<div class="register_form_wrapper">
				...
				<form action="register_into.php" method="post" class="register_form">
					<br/><br/>
					Name
					<br/>
					<input type="text" class="register_input" name="first_name" placeholder="First" ></input>
					<input type="text" class="register_input" name="last_name" placeholder="Last" style="margin-left: 10px;" ></input>


					<br/><br/>
					Enter Email ID
					<br/>
					<input type="text" class="register_input" name="email_id" placeholder="Email Address" size="47.50" ></input>

					<br/><br/>
					Create a Password
					<br/>
					<input type="password" class="register_input" name="password1" placeholder="Enter Password" max-length="30" size="47.50" ></input>

					<br/><br/>
					Confirm your Password
					<br/>
					<input type="password" class="register_input" name="password2" placeholder="Confirm Password" max-length="30" size="47.50" ></input>


					<br/><br/>
					Mobile Phone
					<br/>
					<input type="text" class="register_input" name="mobile_no" placeholder="(+91) -" size="47.50" ></input>
