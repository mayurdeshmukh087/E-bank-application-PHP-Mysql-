...
<!--<div class="basic_info" style="margin: 15px;width: 50em;height: 45px; display: none; font-size: 15px;"> --> 
							<form action="settings_check.php" method="post">
								Enter the New Password -<input type="password" class="register_input" name="newpassword1" placeholder="Enter the new Password" max-length="30" size="30" style="border-radius: 5px;height: 20px; font-size: 15px;" ></input>
								<input type="password" class="register_input" name="newpassword2" placeholder="Enter the Password Again." max-length="30" size="30" style="border-radius: 5px;height: 20px; font-size: 15px;" ></input>
