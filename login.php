	...
	<BODY>
		...
		<div class="form_css">
			<center>
				...
				<br/>
				<div class="login_css">
					<form action="validate.php" method="post" name="login_validate">
						Account Number : <input type="text" class="user_id" name="acc_no" placeholder="Enter Username" maxlength="10" size="28"></input>
						<br/><br/>
						Email ID &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="email" class="user_id" name="email_id" placeholder="Enter Username" maxlength="30" size="28"></input>
						<br/><br/>
						Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="password" class="pass_id" name="pass" placeholder="Enter Password" maxlength="20" size="28"></input>
